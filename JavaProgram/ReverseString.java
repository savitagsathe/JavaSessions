...
public class ReverseString {
	public static void main(String args[])
	{
		...
		/*Program 3 : WAP to count no. of times letter A has occcured in a given string
		...
		/*PROGRAM 12 : WAP to compute quotient and reminder*/
		/*int dividend=30;
		int divisor=5;
